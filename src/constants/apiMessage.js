...
export const REPORTE_CREADO = 'Se esta generado el reporete';
export const REPORTE_TERMINDO = 'El reporte se a finalizado';
export const REPORTE_YA_CREADO = 'El reporete ya existe, ve el menu reporets';
export const FICHA_CREADO = 'Se esta genreado la ficha para el animal';
export const FICHA_TERMINDO = 'Se a termindo de realizar la ficha de un animal';
export const FICHA_YA_CREADO = 'Ya existe la ficha para este animal, vea la seccion de reportes';
